...
if (hora >= 0 && hora < 12) {
    saudacao.innerHTML = "Bom dia, <strong>Aline Victor</strong> 👋"
} else if (hora >= 12 && hora < 18) {
    saudacao.innerHTML = "Boa tarde, <strong>Aline Victor</strong> 👋"
} else {
    saudacao.innerHTML = "Boa noite, <strong>Aline Victor</strong> 👋"
}
...
function atualizarLista() {
    ...
    tarefas.forEach((tarefa, index) => {
        ...
        if (tarefa.concluida){ div.classList.add("concluida");  carregaStorage()}
        ...
        div.innerHTML = `
            ...
            <button onclick="removerTarefa(${index})"><img src="./trash.png"></img></button>
        `;
